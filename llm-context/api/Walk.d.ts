...
/** */
export interface IWalkerCursor {
    /**
...
/** A type that acts as a steering mechanism to control the walking of a tape. */
type TWalkerDirective = void | "skip" | "stop";
/**
 * Performs a full recursive walk of the Mask objects that have been layered over the
 * specified Tape. The traversal does not visit tokens or other non-mask values that
 * reside in properties inside Mask objects.
 */
export declare function walk(tape: X.Tape, visitFn: (cursor: IWalkerCursor) => TWalkerDirective): void;
export {};
